<?PHP
	...
	$bookname = 'Bead Box';
	$bookcover_big = 'book__covers/e_bead_box.jpg';
	$bookcover_small = 'book__thumbnails/e_bead_box_thumb.jpg';
	$bookcover_width = '225';
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p class="clearfix">An easily transported sampling device, this contains seven bead colors. Various combinations allow any percent from 0.5% to 20% to be sampled. A 100-hole sampling pattern is on one side. A vinyl carrying case is included. </p>

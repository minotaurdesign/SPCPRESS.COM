<?PHP
	...
	$bookname = 'Chip Box';
	$bookcover_big = 'book__covers/e_chipbox.jpg';
	$bookcover_small = 'book__thumbnails/e_chipbox_thumb.jpg';
	$bookcover_width = '225';
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p class="clearfix">This tool demonstrates the use of samples to make estimates about populations. It consists of a plexiglas box that holds a series of numbered chips (approximately normally distributed). Included are 802 chips in 4 colors.</p>

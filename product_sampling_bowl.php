<?PHP
	...
	$bookname = 'Plexiglas Sampling Bowl';
	$bookcover_big = 'book__covers/e_sampling_bowl.jpg';
	$bookcover_small = 'book__thumbnails/e_sampling_bowl_thumb.jpg';
	$bookcover_width = '225';
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p class="clearfix">This plexiglas sampling bowl can be used for teaching probability theory and the Deming Red Bead Experiment. It includes three sampling paddles (20, 50, 100 holes) and 2600 beads (1800 white, 400 red, 100 yellow, 100 green, 100 black, 100 blue); colors may be customized.</p>

        <h4>Size:</h4>
        <p>14" wide x 11.5" high x 9" deep</p>
        <h4>Price:</h4>
        <p>$590.00</p>
    </section>

...
<head class="html5reset-bare-bones">
	...
	<meta charset="utf-8">
	<!--[if IE]><![endif]-->
	<title>SPC Press - Store Visitors</title>
...
<div id="wrap">
    ...
    <section class="instructions">  
        <header>
            <h1>Welcome to SPC Press…the home of Quality Service!</h1>
        </header>  
        <p>It looks like you have found an outdated product url. Please select <a href="books.php"><strong>books</strong></a> or <a href="other_products.php"><strong>other products</strong></a>  in order to continue browsing. </p>
    ...
    <section>
        <header>
            ...
            <h1><a href="other_products.php">Other Products</a></h1>
        </header>
    </section>

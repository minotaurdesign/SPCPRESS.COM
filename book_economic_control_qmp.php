<?PHP
	...
	$bookname = 'Economic Control of Quality of Manufactured Product';
	$edition = '';
	$authorname = 'Walter A. Shewhart';
	$bookcover_big = 'book__covers/ecqmp.jpg';
	$bookcover_small = 'book__thumbnails/thumb_ecqmp.jpg';
	$bookcover_width = 225;
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p>Dr. Walter Shewhart has been called “The Father of Modern Quality Control,” and he was an important mentor to Dr. W. Edwards Deming. He brought together the disciplines of statistics, engineering, and economics in a simple but highly effective tool: the control chart, now often called the process behavior chart. This is his definitive book, originally published in 1931 and republished in 1980 with a dedication written by W. Edwards Deming. This special edition covers all aspects of SPC: specifications, problems with inspection, improvement of processes, operational definitions, and problems in the definition of quality.</p>
		...
		<ul id="bookdata">
			...
			?>	   
            <li>501 pages, softcover</li>
			<!--<li>release date: 1980  </li>-->
			<li>ISBN 978-0-873890-76-2 </li>
            <li>$42.00</li>
        </ul>
    </section>

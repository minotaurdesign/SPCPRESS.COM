<?PHP
	...
	$bookname = 'Beyond Capability Confusion';
	$edition = 'Second Edition';
	$authorname = 'Donald J. Wheeler';
	$bookcover_big = 'book__covers/bcc.jpg';
	$bookcover_small = 'book__thumbnails/thumb_bcc.jpg';
	$bookcover_width = 225;
	$bookcover_height = 286;
	$bookdata = 'toc_bcc.pdf';
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p>Capability is concerned with characterizing what a process will produce in the future, and readers will learn how to make such predictions with accuracy and confidence. This discussion of capability goes beyond mere computations to illustrate the concepts, the pitfalls, and the appropriate uses of capability indexes for both predictable and unpredictable processes. Examples using data from real-world processes make the ideas clear and easy to grasp. In this popular book Dr. Wheeler has provided practical guidance, based on sound theory, to a perennial problem faced by professionals working in Continual Improvement. </p>
		...
		<ul id="bookdata">
			...
			?>	
            <li>150 pages, 89 figures, 24 examples, <br>39 tables, softcover</li>
            <!--<li>release date: July 2000</li>-->
            <li>ISBN 978-0-945320-57-9</li>
            <li> $35.00</li>
        </ul>
    </section>

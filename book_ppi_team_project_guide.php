<?PHP
	...
	$bookname = 'Practical Process Improvement Team Project Guide';
	$edition = '';
	$authorname = 'Jason Stone and R. Edward Zunich';
	$bookcover_big = 'book__covers/ppi_team_project_guide.jpg';
	$bookcover_small = 'book__thumbnails/thumb_ppi_instructors_guide.jpg';
	$bookcover_width = 225;
	$bookcover_height = 297;
	$bookdata = '';
	$bookdescription = 'This is a guidebook for the application of The Eight Step Method and the various Practical Process Improvement tools to help teams complete their projects. ';
?>
<!DOCTYPE html>
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p class="clearfix">This is a guidebook for the application of The Eight Step Method and the various Practical Process Improvement tools to help teams complete their projects.  It is primarily intended as a step-by-step manual for Facilitators, Team Leaders, and Process Champions. It is rich with illustrations and examples, including presentation of the final report of a successful PPI Team.</p>

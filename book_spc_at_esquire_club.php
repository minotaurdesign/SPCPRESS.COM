<?PHP
	...
	$bookname = 'SPC at the Esquire Club';
	$edition = '';
	$authorname = 'Donald J. Wheeler';
	$bookcover_big = 'book__covers/esquire.jpg';
	$bookcover_small = 'book__thumbnails/thumb_esquire.jpg';
	$bookcover_width = 225;
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p class="clearfix">This is a service example you won’t forget! The story is a simple one with a strong message—a powerful case study of Continual Improvement Tools being used successfully by workers with limited mathematical training. It demonstrates that anyone, anywhere, can use these tools to improve quality and productivity. If these waitresses can reduce loss on beer and saki sales, you and your employees can certainly improve the situation in your company.</p>
        ...
        <ul id="bookdata">
			...
			?>	
            <li>65 pages, softcover</li> 
            <!--<li>release date: Fall 1992  </li>-->
            <li>ISBN 978-0-945320-30-2</li>
            <li>$10.00</li>
         </ul>
    </section>

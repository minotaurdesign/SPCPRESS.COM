<?PHP
	...
	$bookname = 'Comprende La Variation La Cle pour Eviter le Chaos';
	$edition = '';
	$authorname = 'Donald J. Wheeler, Traduit par Mike Kazeef';
	$bookcover_big = 'book__covers/comprendeV.jpg';
	$bookcover_small = 'book__thumbnails/thumb_comprendeV.jpg';
	$bookcover_width = 225;
	$bookcover_height = 325;
	$bookdata = '';
	$bookdescription = 'This is a French translation of the Second Edition of Dr. Wheeler’s popular book for managers, Understanding Variation.';
?>
<!DOCTYPE html>
...
<div id="wrap">
    ...
    <section class="book">  
        ...
        <p class="clearfix">This is a French translation of the Second Edition of Dr. Wheeler’s popular book for managers, <em>Understanding Variation</em>.</p>
...
<ul id="bookdata">
			...
			?>	
            <li>166 pages, softcover</li>
			<!--<li>release date: July 2001</li>-->
			<li>ISBN 978-0-945320-59-3</li>
            <li> $30.00</li>
        </ul>
    </section>
